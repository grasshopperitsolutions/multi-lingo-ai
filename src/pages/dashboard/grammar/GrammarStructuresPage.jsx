...
const GrammarStructuresPage = () => {
  ...
  if (!supported) {
    return (
      <FeaturePageShell showPracticeLanguage isDarkMode={isDarkMode} accentColor="amber" breadcrumbItems={breadcrumbItems} title={t("grammar.structures")} reportContext="GrammarStructuresPage">
