...
const GrammarTipsPage = () => {
  ...
  if (!supported) {
    return (
      <FeaturePageShell showPracticeLanguage isDarkMode={isDarkMode} accentColor="amber" breadcrumbItems={breadcrumbItems} title={t("grammar.tips")} reportContext="GrammarTipsPage">
