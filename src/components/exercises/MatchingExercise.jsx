    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col gap-2">
          ...
          {pairs.map((pair, i) => (
            <div key={pair.id} className={`flex items-center gap-2 px-4 py-3 rounded-xl border-2 ${matches[pair.id] ? (isDarkMode ? 'bg-indigo-900/30 border-indigo-600' : 'bg-indigo-50 border-indigo-400') : (isDarkMode ? 'bg-slate-800 border-slate-600' : 'bg-white border-slate-300')}`}>
