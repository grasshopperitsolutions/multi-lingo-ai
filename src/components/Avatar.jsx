 ...
 * Optionally shows a Beta pill on top-right via the `showBetaBadge` prop.
 */
const Avatar = ({ src, alt, size = 64, isDarkMode = false, className = "", showBetaBadge = false }) => {
...
Avatar.propTypes = {
  ...
  /** Show the Beta pill on top-right corner */
