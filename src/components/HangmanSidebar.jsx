 ...
 * Props:
 *   isDarkMode      boolean
 *   progress        UserGameProgress | null   — from userService
 *   totalWords      number                    — from getWordPoolCount
 *   isLoadingStats  boolean
 *   onReset         () => Promise<void>        — clears seenConceptIds
 */
const HangmanSidebar = ({ isDarkMode, progress, totalWords, isLoadingStats, onReset }) => {
  ...
  return (
    <>
      ...
      {/* Mobile bottom strip — always visible, no collapse */}
